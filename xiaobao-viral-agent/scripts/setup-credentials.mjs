...
if (!apiKey || apiKey === true) {
    console.error('用法: node setup-credentials.mjs --api-key YOUR_KEY [--base-url https://apis.xiaobao.ink]')
    process.exit(1)
}

const file = saveCredentials({ base_url: baseUrl, api_key: String(apiKey) })
